                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  pilihanWaktu == "6 Bulan"
                                      ? data.imbalHasil[0] + "/6bln"
                                      : data.imbalHasil[1] + "/th",
                                  style: TextStyle(
                                    color: Colors.green,
                                    fontWeight: FontWeight.bold,
                                  ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  pilihanWaktu == "6 Bulan"
                                      ? data.imbalHasil[2] + "/6bln"
                                      : data.imbalHasil[3] + "/th",
                                  style: TextStyle(
                                    color: Colors.green,
                                    fontWeight: FontWeight.bold,
                                  ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  pilihanWaktu == "6 Bulan"
                                      ? data.imbalHasil[4] + "/6bln"
                                      : data.imbalHasil[5] + "/th",
                                  style: TextStyle(
                                    color: Colors.green,
                                    fontWeight: FontWeight.bold,
                                  ),
